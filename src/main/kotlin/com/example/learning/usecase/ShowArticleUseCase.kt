package com.example.learning.usecase

import arrow.core.Either
import com.example.learning.domain.CreatedArticle
import com.example.learning.domain.Slug
...
interface ShowArticleUseCase {
    ...
    sealed interface Error {
         ...
         * @property slug
         */
        data class NotFoundArticleBySlug(
            val slug: Slug,
        ) : Error
    }
}
