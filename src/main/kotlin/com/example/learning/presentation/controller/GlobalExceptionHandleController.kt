...
class GlobalExceptionHandleController {
    ...
    fun noHttpRequestMethodNotSupportedExceptionHandler(e: HttpRequestMethodNotSupportedException): ResponseEntity<GenericErrorModel> =
        ResponseEntity<GenericErrorModel>(
            GenericErrorModel(
                errors =
                    GenericErrorModelErrors(
    ...
    fun noHttpMediaTypeNotSupportedException(e: HttpMediaTypeNotSupportedException): ResponseEntity<GenericErrorModel> =
        ResponseEntity<GenericErrorModel>(
            GenericErrorModel(
                errors =
                    GenericErrorModelErrors(
    ...
    fun constraintViolationExceptionExceptionHandler(e: ConstraintViolationException): ResponseEntity<GenericErrorModel> {
        ...
        val messages =
            e.constraintViolations.map {
                 ...
                 */
                val chainCaseRequestParam =
                    it.propertyPath.toString().split('.').last().split(Regex("(?=[A-Z])")).joinToString("-") { param ->
                        param.lowercase(
                            Locale.getDefault(),
                        )
                    }
