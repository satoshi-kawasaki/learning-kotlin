package com.example.learning.presentation.controller

import arrow.core.getOrElse
import com.example.learning.presentation.model.Article
import com.example.learning.presentation.model.GenericErrorModel
import com.example.learning.presentation.model.GenericErrorModelErrors
import com.example.learning.presentation.model.SingleArticleResponse
import com.example.learning.usecase.ShowArticleUseCase
...
class ArticleController(
    ...
    fun getArticle(
         ...
         */
        val createdArticle =
            showArticleUseCase.execute(slug).getOrElse {
     ...
     * @property error
     */
    data class ShowArticleUseCaseErrorException(
        val error: ShowArticleUseCase.Error,
    ) : Exception()
    ...
    fun onShowArticleUseCaseErrorException(e: ShowArticleUseCaseErrorException): ResponseEntity<GenericErrorModel> =
        when (val error = e.error) {
             ...
             */
            is ShowArticleUseCase.Error.NotFoundArticleBySlug ->
             ...
             * 原因: バリデーションエラー
             */
            is ShowArticleUseCase.Error.ValidationErrors ->
                ResponseEntity<GenericErrorModel>(
                    GenericErrorModel(
                        errors =
                            GenericErrorModelErrors(
